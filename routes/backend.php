...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function() {
    ...
    //Custom
    Route::get('/council', ['as' => 'admin.council.index', 'uses' => 'Backend\CouncilController@index']);
    Route::get('/council/create', ['as' => 'admin.council.create', 'uses' => 'Backend\CouncilController@create']);
    Route::get('/council/edit/{id}', ['as' => 'admin.council.edit', 'uses' => 'Backend\CouncilController@edit']);
    Route::post('/council/store', ['as' => 'admin.council.store', 'uses' => 'Backend\CouncilController@store']);
    Route::post('/council/update/{id}', ['as' => 'admin.council.update', 'uses' => 'Backend\CouncilController@update']);
    Route::delete('/council/delete/{id}', ['as' => 'admin.council.destroy', 'uses' => 'Backend\CouncilController@destroy']);

    Route::get('/candidates', ['as' => 'admin.candidates.index', 'uses' => 'Backend\CandidatesController@index']);
    Route::get('/candidates/create', ['as' => 'admin.candidates.create', 'uses' => 'Backend\CandidatesController@create']);
    Route::get('/candidates/edit/{id}', ['as' => 'admin.candidates.edit', 'uses' => 'Backend\CandidatesController@edit']);
    Route::post('/candidates/store', ['as' => 'admin.candidates.store', 'uses' => 'Backend\CandidatesController@store']);
    Route::post('/candidates/update/{id}', ['as' => 'admin.candidates.update', 'uses' => 'Backend\CandidatesController@update']);
    Route::delete('/candidates/delete/{id}', ['as' => 'admin.candidates.destroy', 'uses' => 'Backend\CandidatesController@destroy']);
