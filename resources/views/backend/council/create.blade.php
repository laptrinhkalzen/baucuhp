                                    ...
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <fieldset>
                                            <div class="form-group row">
                                                <label class="col-md-3 col-form-label text-right">Tên đơn vị bầu cử <span class="text-danger">*</span></label>
                                                <div class="col-md-9">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="total_candidates" value="{!!old('total_candidates')!!}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="elected_candidates" value="{!!old('elected_candidates')!!}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="total_voters" value="{!!old('total_voters')!!}">
                                        ...
                                        <div class="text-right">
                                            <a type="button" href="{{route('admin.council.index')}}" class="btn btn-secondary legitRipple">Hủy</a>
