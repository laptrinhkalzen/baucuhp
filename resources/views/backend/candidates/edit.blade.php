...
@section('content')
<div class="content">
    <form action="{!!route('admin.candidates.update', ['id' => $record->id])!!}" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                                    ...
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-check">
                                                      <input class="form-check-input" type="radio" value="Nam" name="sex_cd" id="male" <?php if($record->sex_cd=='Nam') echo('checked') ?>>
                                                      <label class="form-check-label" for="male">
                                                        Nam
                                                      </label>
                                                    </div>
                                                    <div class="form-check">
                                                      <input class="form-check-input" type="radio" value="Nữ" name="sex_cd" id="female" <?php if($record->sex_cd=='Nữ') echo('checked') ?>>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="date" class="form-control" name="birthday" value="{!!$record->birthday!!}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="title3_cd" value="{!!is_null(old('title3_cd'))?$record->title3_cd:old('title3_cd')!!}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control" name="story_cd">{!!is_null(old('story_cd'))?$record->story_cd:old('story_cd')!!}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
